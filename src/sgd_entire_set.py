...
if __name__ == '__main__':
    ...
    print
    clf = SGDClassifier(loss="hinge", penalty="l2") # Beware! You need 10Gb RAM to train LogisticRegression on all 16 subjects!
    print "Classifier:"
    print clf
    print "Training."
    ...
    print
    filename_submission = "../output/submissionSGDEntire.csv"
